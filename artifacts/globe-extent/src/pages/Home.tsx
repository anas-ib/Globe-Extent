    ...
    >
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            Transforming Vision Into <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-yellow-200 to-accent">Global Reality.</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-white/70 font-sans max-w-3xl mx-auto mb-12 leading-relaxed"
          >
            A premium multi-service consulting firm providing end-to-end solutions for entrepreneurs, startups, and global enterprises.
          </motion.p>
